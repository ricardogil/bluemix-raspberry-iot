...
//see https://www.npmjs.com/package/ibmiotf
 ...
 */
var iotPlatformServiceName = 'iot-dojo-gil-20170203';
...
appClient.on("connect", function () {
  console.log("subscribe to input events");
	...
	appClient.subscribeToDeviceEvents("rasp");
});
...
appClient.on("deviceEvent", function(deviceType, deviceId, eventType, format, payload){
	console.log("deviceEvent: " + JSON.parse(payload) + ", eventType:" + eventType);
  if (eventType === 'status'){
